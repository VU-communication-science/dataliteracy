---
title: "3.5. Scale construction"
---

## 3.5.1. What is a scale?
...
### 3.5.1.1. How to create a scale {#create-scale}
...
#### 3.5.1.1.1. 1. Choose the items based on theory
...
#### 3.5.1.1.3. 3. Look at the correlations
...
#### 3.5.1.1.4. 4. Invert items if necessary
...
#### 3.5.1.1.5. 5. Calculate the reliability
...
#### 3.5.1.1.6. 6. Remove items if necessary
...
#### 3.5.1.1.7. 7. Calculate the scale score
