...
### 2.1.2.2. Using RStudio projects
...
### 2.1.3.1. The power of assignment
...
#### 2.1.3.1.1. Assigning versus printing
...
#### 2.1.3.1.2. Assigning different types of objects
...
## 2.1.4. Types of objects

### 2.1.4.1. Common types of objects
...
#### 2.1.4.1.1. Types determine what you can do with an object
...
#### 2.1.4.1.2. You can coerce objects to different types
...
### 2.1.4.2. Vectors and Data Frames
...
#### 2.1.4.2.1. From Single Values to Vectors
...
#### 2.1.4.2.2. From Vectors to Data Frames
...
### 2.1.5.1. What is a function? {#what-is-a-function}
...
#### 2.1.5.1.1. Optional arguments {#optional-arguments}
...
#### 2.1.5.1.2. Using the pipe syntax {#pipe-syntax}
...
### 2.1.6.1. What is a package? {#what-is-a-package}
