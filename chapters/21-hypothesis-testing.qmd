---
title: "6.1. Hypothesis testing"
---

## 6.1.1. Deriving hypotheses from theories
...
To build stronger evidence, we therefore need to design our studies in such a way that we can rule out these alternative explanations, for instanced by conducting **randomized controlled trials**, or by **statistically controlling** for confounders [Also see the tutorial on causality](22-causality.qmd).
