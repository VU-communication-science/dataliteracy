...
## 2.3.1. Integrating code and text
...
### 2.3.1.1. Creating a Quarto file
...
#### 2.3.1.1.2. 2. The textual content
...
#### 2.3.1.1.3. 3. The code chunks

At some point you see a code chunk, which looks like:

```{r 3-the-code-chunks-1, eval=F}
{r}
1 + 1
```
...
### 2.3.1.2. Rendering the document
...
## 2.3.2. Some tips and warnings

### 2.3.2.1. Turn on `'Render on save'`
...
#### 2.3.2.1.1. The working directory is the folder where the Quarto file is located

A Quarto file will always use it's own location as the [working directory](05-projects.qmd#choosing-working-directory)
