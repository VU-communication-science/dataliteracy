...
## 2.2.1. Keeping track of your data {#file-management}
...
## 2.2.2. Recommended approach: stick to your working directory
...
```{r recommended-approach-stick-to-your-working-directory-1, eval=F}
getwd()
```
```{r recommended-approach-stick-to-your-working-directory-2}
...
### 2.2.2.1. Writing a file to your working directory

The following code writes a plain text file name `hello_world.txt` to your current working directory.

```{r writing-a-file-to-your-working-directory-1, eval=F}
...
```{r writing-a-file-to-your-working-directory-2, results=F}
list.files()                    ## show all files
list.files(pattern="*.txt")     ## show files with .txt extension
```

### 2.2.2.2. Reading a file from your working directory
...
```{r reading-a-file-from-your-working-directory-1, eval=F}
...
### 2.2.2.3. Choosing your working directory {#choosing-working-directory}
...
**If you are working in a Quarto file**, ([as we explain here](06-quarto.qmd)), the working directory is always the directory where the Quarto file is located (and you cannot change it).
...
## 2.2.3. Optional: working with absolute paths
...
```{r optional-working-with-absolute-paths-1, eval=F}
...
```{r optional-working-with-absolute-paths-2, eval=FALSE}
/ (Root Directory) 
│
├── Documents
│   ├── Work
...
#### 2.2.3.1.2. Using the file explorer
...
#### 2.2.3.1.3. Using tab completion 
